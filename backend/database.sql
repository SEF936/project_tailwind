...
INSERT INTO `product` (`name`, `description`, `category_id`, `image`, `color`, `size`, `price`, `promotionalPrice`, `adding_date`)
VALUES
('Robe à imprimé floral à nœud découpe','superbe robe quyi va voud jhsp^mfiofh oiehf oihenf oihe foçe  pçzeçà FP09je f àig', 2, "robe1_1.webp", "blue", "L", 34.99, 22.99, "2023-04-03"),
('Jupe à imprimé floral à nœud découpe','superbe robe quyi va voud jhsp^mfiofh oiehf oihenf oihe foçe  pçzeçà FP09je f àig', 1, "robe2_1.webp", "blue", "XL", 64.99, 44.99, "2023-05-03"),
('Robe à imprimé floral à nœud découpe','superbe robe quyi va voud jhsp^mfiofh oiehf oihenf oihe foçe  pçzeçà FP09je f àig', 2, "robe3_1.webp", "blue", "L", 54.99, 32.99,"2023-06-03"),
('Jupe à imprimé floral à nœud découpe','superbe robe quyi va voud jhsp^mfiofh oiehf oihenf oihe foçe  pçzeçà FP09je f àig', 1, "robe4_1.webp", "blue", "S", 84.99, 42.99,"2023-01-03");